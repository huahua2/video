function createPicMove(a, b, c) {
	...
	var h = function(k, n, m, l) {
		...
		//console.log(this._slider[j ? "offsetHeight": "offsetWidth"] / this._count);
		this.Change = this.options.Change ? this.options.Change: w
	};
	h.prototype = {
...
//活动轮播图
var st, autoplay, picCount = null;
function images_carousel() {

     autoplay = $("#autoplay").val() == "1" ? true : false;
